<script>
	...
	/** @type {'office' | 'media' | 'organise' | null} */
	let activePill = $state(null);

	function togglePill(/** @type {'office' | 'media' | 'organise'} */ pill) {
...
>
	...
	{#if nodesState.activeTool === "pencil"}
		...
		>
			<!-- Colors -->
			<div class="flex gap-1.5 border-r border-border pr-3">
	...
	>
		...
		>
			...
			>
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Select <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("tool-pointer")}]</span
				></span
			>
		</button>

		<button
			onclick={() => (nodesState.activeTool = "pan")}
			class="group relative flex items-center justify-center w-8 h-8 rounded-none transition-colors {nodesState.activeTool ===
			'pan'
				? 'text-accent bg-accent/20 shadow-[inset_0_-2px_0_0_var(--color-accent)]'
				: 'text-text-secondary hover:text-text-primary hover:bg-text-primary/10'}"
		>
			...
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Pan <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("tool-pan")}]</span
				></span
			>
		</button>
		...
		>
			...
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Draw <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("tool-pencil")}]</span
				></span
			>
		</button>
		...
		>
			...
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Erase <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("tool-eraser")}]</span
				></span
			>
		</button>
		...
		>
			...
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Text <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("tool-text")}]</span
				></span
			>
		</button>
		...
		>
			<svg
				...
				stroke-linecap="round"
				stroke-linejoin="round"
				><path d="M4 4h16v16H4z" /><path d="M4 8h16" /><path
					d="M8 4v16"
				/></svg
			>
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Frame <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("add-frame")}]</span
				></span
			>
		</button>
		...
		>
			...
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Note <span class="ml-1 opacity-50"
					>[{shortcutsState.getLabel("add-note")}]</span
				></span
			>
		</button>
		...
		<div class="relative">
			<button
				...
				class="group relative flex items-center justify-center w-8 h-8 rounded-none transition-colors {activePill ===
				'office'
					? 'text-accent bg-accent/20 shadow-[inset_0_-2px_0_0_var(--color-accent)]'
					: 'text-text-secondary hover:text-text-primary hover:bg-text-primary/10'}"
			>
			...
			{#if activePill === "office"}
				...
				>
					...
					>
						...
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Doc <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-doc")}]</span
							></span
						>
					</button>
					<button
					...
					>
						<svg
							...
							><rect
								...
								y="3"
								rx="2"
							/><path d="M3 9h18" /><path d="M3 15h18" /><path
								d="M9 3v18"
							/></svg
						>
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Sheet <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-sheet")}]</span
							></span
						>
					</button>
				</div>
			...
			{#if activePill === "organise"}
				...
				>
					...
					>
						...
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Board <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-board")}]</span
							></span
						>
					</button>
					<button
					...
					>
						...
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Deck <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-column")}]</span
							></span
						>
					</button>
					<button
					...
					>
						<svg
							...
							stroke-linecap="round"
							stroke-linejoin="round"
							><path d="m12 2 8 4.5v11L12 22l-8-4.5v-11Z" /><path
								d="m12 12 8-4.5"
							/><path d="M12 12v10" /><path d="m12 12-8-4.5" /></svg
						>
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Stack <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-stack")}]</span
							></span
						>
					</button>
				</div>
			...
			{#if activePill === "media"}
				...
				>
					...
					>
						...
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Image <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-image")}]</span
							></span
						>
					</button>
					<button
					...
					>
						...
						<span
							class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-accent border-border text-accent text-[10px] uppercase font-mono font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
							>Video <span class="ml-1 opacity-50"
								>[{shortcutsState.getLabel("add-video")}]</span
							></span
						>
					</button>
				</div>
		...
		>
			...
			>
			<span
				class="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 bg-surface border border-t-red-500 border-border text-red-500 text-[10px] font-bold tracking-widest rounded-none px-2 py-1 shadow-[0_5px_15px_rgba(0,0,0,0.8)] whitespace-nowrap pointer-events-none transition-opacity"
				>Clear All</span
			>
		</button>
